...
class CalificacionPublicSerializer(serializers.ModelSerializer):
    autor_nombre = serializers.SerializerMethodField()
    articulo_id = serializers.UUIDField(source="alquiler.articulo_id", read_only=True)

    class Meta:
        model = Calificacion
        fields = ("id", "articulo_id", "puntaje", "comentario", "fecha", "autor_nombre")
    ...
    def get_autor_nombre(self, obj):
        ...
        return full or getattr(u, "email", "") or getattr(u, "username", "Usuario")
